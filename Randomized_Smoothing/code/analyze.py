...
if __name__ == "__main__":
    ...
    data_N25_S25 = "data/certify/cifar10/resnet50/noise_0.25/test/sigma_0.25.txt"
    data_N50_S50 = "data/certify/cifar10/resnet50/noise_0.50/test/sigma_0.50.txt"
    data_N100_S100 = "data/certify/cifar10/resnet50/noise_1.00/test/sigma_1.00.txt"


    latex_table_certified_accuracy(
        pth+"analysis/latex/vary_noise_cifar10", 0.25, 1.5, 0.25, [
            Line(ApproximateAccuracy(pth+data_N25_S25), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy(pth+data_N50_S50), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy(pth+data_N100_S100), "$\sigma = 1.00$"),
        ])
    plot_certified_accuracy(
        pth+"analysis/plots/vary_noise_cifar10", "CIFAR-10, vary $\sigma$", 1.5, [
            Line(ApproximateAccuracy(pth+data_N25_S25), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy(pth+data_N50_S50), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy(pth+data_N100_S100), "$\sigma = 1.00$"),
        ])
